...
function mclick(o){
  ...
  const l = window.location.href
	...
	switch ( o.classList[0] ) {
		case "facebook":
			window.open( "https://facebook.com/sharer.php?u=uu&quote=tt".replaceAll(l, t), "_blank", "width=600,height=400" );
		break;
		case "twitter":
			window.open( "https://twitter.com/share?url=uu&text=tt&via=visitbamyan".replaceAll(l, t), "_blank", "width=600,height=400" );
		break;
		case "whatsapp":
      window.location.href = "https://wa.me/?text=tt: uu".replaceAll(l, t);
		break;
		case "mailto":
			window.location.href = "mailto:?&subject=tt&body=tt%0A%0Auu".replaceAll(l, t);
		break;
		case "share":
			navigator.share({
...
String.prototype.replaceAll = function(link, title){
	var str = this;
	str = str.replace(/uu/g, link);
	str = str.replace(/tt/g, title);
	return str;
}
...
if(moc){
  let modhtml = '<div class=mod><div><span class=clx><svg viewBox="0 0 453.54 453.54"><use xlink:href="#close"></use></svg></span><div class=c></div></div></div>'
